...
| Must<br>Have | As a householder, I want to be able to donate to an available project of my choice on Solar Offset via paypal, so that I can contribute towards offsetting my carbon footprint and I can let Solar Offset keep track of my donations for me. |
