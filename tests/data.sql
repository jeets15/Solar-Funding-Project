...
VALUES
    ...
    -- Guess electricity consumption to be around 2TWh per year
    ...
    -- United of America
    ('USA', 'US', 'United States', 3000, 1600000000, 2500, 0.2, 4000,
...
\nThe United States has a diverse energy mix, with a significant reliance on fossil fuels like natural gas and coal, as well as growing renewable energy sources like solar and wind power. The country has made progress in increasing its renewable energy capacity, but there is still room for further growth and development in this area to reduce carbon emissions and address climate change concerns.');
    ...
    -- South Africa
    ('ZAF', 'ZA', 'South Africa', 2800, 440000000, 1500, 0.1, 250,
...
-- Argentina
('ARG', 'AR', 'Argentina', 2800, 440000000, 1500, 0.1, 250,
...
-- Australia
('AUS', 'AU', 'Australia', 3000, 180000000, 1500, 0.2, 250,
...
-- Brazil
('BRA', 'BR', 'Brazil', 2600, 65000000, 1500, 0.2, 500,
...
-- Saudi Arabia
('SAU', 'SA', 'Saudi Arabia', 3285, 600000000, 2000, 0.0038, 300,
